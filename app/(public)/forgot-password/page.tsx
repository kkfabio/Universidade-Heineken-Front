...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFB] w-full select-none">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-[#008200] p-16 lg:flex overflow-hidden">
        <div 
        ...
        <div className="relative z-10 flex items-center gap-2 mb-2">
          <div className="bg-white rounded-full h-6 w-6 leading-none flex items-center justify-center shadow-sm">
            <span className="text-[#008200] text-xs font-black">★</span>
          </div>
      ...
      <div className="flex w-full items-center justify-center p-6 sm:p-12 lg:w-1/2 bg-white shadow-2xl z-10">
        <div className="w-full max-w-sm space-y-8">
          ...
          {!success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-slate-50 p-4 text-sm font-medium text-neutral-900 outline-none border border-slate-200/80 focus:border-[#008200] focus:ring-4 focus:ring-[#008200]/5 transition-all placeholder:text-slate-400"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#008200] py-4 text-xs font-bold uppercase tracking-wider text-white transition-all hover:bg-[#008200]/90 active:scale-[0.99] shadow-lg shadow-[#008200]/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="space-y-6 text-center animate-in fade-in zoom-in-95 duration-300">
              <div className="flex justify-center">
                <div className="rounded-full bg-emerald-50 p-3 text-[#008200]">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-slate-50 rounded-2xl border border-slate-100 p-5 text-2xl font-mono font-black tracking-widest text-[#008200] shadow-inner select-all">
                  {temporaryPassword}
                </div>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#008200] py-4 text-xs font-bold uppercase tracking-wider text-white transition-all hover:bg-[#008200]/90 shadow-lg shadow-[#008200]/10"
              >
          ...
          <div className="flex justify-center pt-4 border-t border-slate-100">
            <Link
              href="/login"
              className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#008200] hover:text-[#008200]/80 transition-colors"
            >
