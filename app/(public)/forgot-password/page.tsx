  ...
  return (
    <div className="flex min-h-screen bg-[#F4F4F4]">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-heineken-green p-16 lg:flex overflow-hidden">
        ...
        <div className="relative z-10 text-[8px] text-white/40 tracking-[0.4em] uppercase">EST. 1864</div>
      </div>
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          {!success ? (
            <>
              <div className="space-y-3">
                ...
                <p className="text-gray-500 text-sm leading-snug">
                  Insira seu e-mail e CPF para redefinir sua senha.
                </p>
              </div>
            ...
            <div className="space-y-6 text-center">
              <div className="space-y-3">
                <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Senha resetada!</h2>
                <p className="text-gray-500 text-sm">Sua senha temporária é:</p>
                <div className="bg-gray-100 rounded-lg p-4 text-2xl font-bold tracking-widest text-heineken-green">
                  {temporaryPassword}
                </div>
                <p className="text-gray-400 text-xs">Use essa senha para entrar e depois altere-a nas configurações.</p>
              </div>
              <button
                onClick={() => router.push("/login")}
                className="flex w-full items-center justify-center gap-2 rounded-md bg-heineken-green py-4 text-xs font-bold uppercase tracking-[0.2em] text-white transition-all hover:bg-heineken-dark"
              >
