      ...
      <div>
        ...
        <div className="relative">
          <input 
            ...
            placeholder="••••••••"
            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-heineken-green focus:ring-2 focus:ring-heineken-green/20 outline-none transition-all pr-12"
            required
          />
          <button
            type="button"
