...
export function ModalNovoCurso({ isOpen, onClose }: ModalNovoCursoProps) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        // Em produção: POST para a API e obter o ID retornado.
        // Por ora, geramos um ID mock e redirecionamos para a tela de edição.
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            {/* Modal Container */}
                ...
                >
                    {/* Left Side: Visual Guide / Editorial Moment */}
                    ...
                    <div className="flex-1 flex flex-col overflow-y-auto bg-white p-8 sm:p-12">
                        ...
                        <form className="space-y-6 font-sans flex-1 flex flex-col" onSubmit={handleSubmit}>
                            ...
                            {/* Grid for Carga Horária and Nível */}
