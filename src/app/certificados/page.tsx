...
import { Trophy, Search, Filter, Download, ExternalLink, Star } from "lucide-react"
import { Input } from "../../components/ui/input"
import { Button } from "../../components/ui/button"
import { CertificateCard } from "../../components/CertificateCard"

/**
 * CertificadosPage - Versão de Alta Fidelidade com suporte a imagens
 * Corrigido com Export Default para o roteamento do Next.js
 */
  ...
  return (
    <div className="min-h-screen p-8 md:p-16 bg-[#FBFBFB]">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
        ...
        {/* Badges de Performance (12 Concluídos / 84% Progresso) */}
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-14">
        <div className="relative flex-1 group">
          ...
          <Input 
            ...
            className="pl-16 h-16 rounded-24pxborder-none shadow-[0_4px_20px_rgba(0,0,0,0.03)] bg-white text-slate-600 font-bold placeholder:text-slate-300 focus:ring-2 focus:ring-[#007041]"
          />
        </div>
        <Button variant="outline" className="h-16 px-10 rounded-24pxborder-slate-100 bg-white font-black text-slate-500 gap-3 hover:bg-slate-50 uppercase text-[10px] tracking-widest">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        {/* Coluna de Certificados Normais (Grid 2x2) */}
