...
const news = [
  {
    ...
    description: "Conheça o plano da empresa para acelerar sustentabilidade, eficiência e inovação industrial.",
    tag: "Destaque",
  ...
  },
  {
    ...
    description: "Nossa plataforma centraliza conteúdos, trilhas e atualizações para todos os colaboradores.",
    tag: "Tecnologia",
  ...
  },
  {
    ...
    description: "Uma nova etapa de cooperação fortalece qualidade, rastreabilidade e impacto regional.",
  ...
  },
  {
    ...
    description: "Uma visão estratégica sobre performance, crescimento e prioridades do próximo ciclo.",
    tag: "Negócios",
            ...
            <div className="mt-8 grid grid-cols-1 gap-5 lg:grid-cols-12">
                ...
                <div className="relative z-10 flex h-full min-h-[280px] flex-col justify-between p-5">
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-sm leading-6 text-white/80">
                      Estratégias para reduzir impacto ambiental e ampliar eficiência operacional.
                    </p>
                  </div>
                </div>
              </article>
              ...
              <article className="relative overflow-hidden rounded-[24px] text-white transition duration-200 hover:-translate-y-1 hover:shadow-md lg:col-span-3">
                ...
                <div className="relative z-10 flex min-h-[180px] flex-col justify-between p-5">
                  <span className="text-xs font-semibold uppercase tracking-wide text-white/80">Community</span>
                  <div>
                    <h3 className="text-lg font-semibold leading-snug">Brewing Better Future Festival 2026</h3>
                  </div>
                </div>
              </article>
              ...
              <article className="relative overflow-hidden rounded-[24px] text-white transition duration-200 hover:-translate-y-1 hover:shadow-md lg:col-span-3">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/35 to-transparent" />
                <div className="relative z-10 flex min-h-[180px] flex-col justify-between p-5">
                  <span className="text-xs font-semibold uppercase tracking-wide text-white/80">Atualização</span>
                  <div>
                    <h3 className="text-lg font-semibold leading-snug">Diretrizes de diversidade e inclusão.</h3>
                  </div>
                </div>
              </article>
              ...
              <article className="relative overflow-hidden rounded-[24px] text-white transition duration-200 hover:-translate-y-1 hover:shadow-md lg:col-span-2">
                ...
                <div className="relative z-10 flex h-full min-h-[180px] flex-col justify-end p-5">
                  <h3 className="text-lg font-semibold leading-snug">IA para aprendizagem personalizada.</h3>
                </div>
              </article>

              {/* Loop das demais notícias */}
              {news.map((item) => (
                <article
                  key={item.id}
                ...
                >
                  ...
                  <h3 className="mt-4 text-lg font-semibold leading-snug text-neutral-900">{item.title}</h3>
