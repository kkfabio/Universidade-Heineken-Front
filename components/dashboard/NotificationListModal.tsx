  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        {/* Rota apontada para /configuracoes que existe */}
        <Link
          href="/configuracoes"
          onClick={onClose}
          className="mt-6 block w-full text-center text-xs font-bold uppercase tracking-widest text-heineken-green hover:text-heineken-dark hover:underline transition-all"
        >
